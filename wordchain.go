...
func wordchain(beginWord string, endWord string, wordList []string) [][]string {
...
func main() {
 var start_word = "cat"
var target_word = "dog"
var dictionary= []string{"hot","dot","dog","lot","cot","log","cog","cat"}
	fmt.Println(wordchain(start_word,target_word, dictionary ) )
}